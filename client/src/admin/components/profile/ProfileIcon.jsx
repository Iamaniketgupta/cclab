...
export default function ProfileIcon() {
  ...
  return (
    <div className="relative">
      ...
      {/* Info Section */}
      {isInfoVisible && (
        <div className="absolute top-12 right-0 w-64 p-4 bg-white dark:bg-stone-900 dark:text-gray-100 rounded-lg shadow-lg border border-gray-200 dark:border-stone-800 z-10">
             <div className='relative '>
            {
...
{     currentUserData?.role!=="super-admin" &&     <div className="text-sm  mt-1">Block - {currentUserData?.block}</div>
}        </div>
      )}
    </div>
  );
